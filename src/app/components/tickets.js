...
export default function Tickets() {
  ...
  return (
    <div className="tickets wrapper">
      ...
      <div className="ticket wrapper">
        <div className="left wrapper last-left">
          <div className="date"><span class="pretext">с</span> 17.10</div>
        </div>
        <div className="middle wrapper">
          <div className="city">Кинотеатры России</div>
        </div>
        <div className="right wrapper">
          <a href="https://www.afisha.ru/movie/planeta-maksimus-295258/">Билеты</a>
        </div>
      </div>
    </div>
  )
